# Data-Exploration-Layoffs-Project in SQL

Using the analysis-ready layoffs dataset, I conducted an exploratory analysis to uncover trends across companies, industries, and regions. The dataset spans roughly three years, from March 11, 2020 to March 6, 2023, covering the onset of COVID-19 through the post-pandemic period. Layoffs were most concentrated in the consumer and retail sectors, which were among the hardest hit during the pandemic. Geographically, the United States experienced by far the highest number of layoffs, totaling 256,559 over the period, significantly more than any other country. Yearly comparisons show a clear upward trend in total layoffs, with 2022 recording the highest annual figure at 160,661. Notably, in just the first three months of 2023, layoffs had already reached 125,677, approaching the previous year’s total. A rolling monthly analysis further highlights the progression of layoffs over time, revealing fluctuations in how sharply layoffs increased from month to month and year to year.

[Project 2 - Exploratory Data Analysis.sql]
(https://github.com/user-attachments/files/27273976/Project.2.-.Exploratory.Data.Analysis.sql)
